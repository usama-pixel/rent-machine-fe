...
function Signup({}: Props) {
    ...
    const handleGoogleLogin = (e: SyntheticEvent) => {
        e.preventDefault();
        // router.push(backend_base_url+'auth/google/Signup')
    }
  ...
  return (
    <div className={styles.container}>
        ...
        <form action="" className={styles.form} onSubmit={handleSubmit}>
            <input className={styles.input} value={name} onChange={e => setName(e.target.value)} type="text" name="Name" id="Name" placeholder="Name" />
            <input className={styles.input} value={email} onChange={e => setEmail(e.target.value)} type="email" name="email" id="email" placeholder="E-mail" />
            ...
            <input className={styles.input} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" />
